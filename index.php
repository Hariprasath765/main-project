...
<body>
    ...
    <div class="side ">
         <div class="side1">
            <ul class="list"> 
                <li><a href="./busdetail.php">Add Bus detail</a></li>
                <li><a href="./tabledetail.php">View Bus details</a></li>
				<li><a href="./bus_stop_form.php">Add stop</a></li>
                <li><a href="./bus_stop_table.php">QR code</a></li>
